...
% PLOT_SI_FIG1 - Supplementary Figure 1: Sex-stratified CDC aging
...
% Tom Froese, OIST Embodied Cognitive Science Unit
    ...
    out_pdf = fullfile(paths.figures, 'SI_Fig1_sex_stratified.pdf');
    out_png = fullfile(paths.figures, 'SI_Fig1_sex_stratified.png');
    out_fig = fullfile(paths.figures, 'SI_Fig1_sex_stratified.fig');

    save_large_figure(fig, out_pdf, out_png, out_fig, fig_w_cm, fig_h_cm);

    fprintf('\nSupplementary Figure 1 saved.\n');

    %% ================================================================
    %  CONSOLE SUMMARY (for SI figure legend)
    %  ================================================================

    fprintf('\n--- Summary for SI Fig 1 legend ---\n');
