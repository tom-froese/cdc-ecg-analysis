...
% PLOT_SI_FIG2 - Supplementary Figure 2: CDC predicts healthy HR and
...
% Tom Froese, OIST Embodied Cognitive Science Unit
    ...
    print(fig, fullfile(paths.figures, 'SI_Fig2_cdc_vs_hr.pdf'), '-dpdf', '-painters');
    print(fig, fullfile(paths.figures, 'SI_Fig2_cdc_vs_hr.png'), '-dpng', '-r300');
    savefig(fig, fullfile(paths.figures, 'SI_Fig2_cdc_vs_hr.fig'));

    fprintf('Saved: %s\n', fullfile(paths.figures, 'SI_Fig2_cdc_vs_hr.pdf'));
    fprintf('Saved: %s\n', fullfile(paths.figures, 'SI_Fig2_cdc_vs_hr.png'));
    fprintf('Saved: %s\n', fullfile(paths.figures, 'SI_Fig2_cdc_vs_hr.fig'));
end
