...
% Tom Froese, OIST Embodied Cognitive Science Unit
    ...
    out_pdf = fullfile(paths.figures, 'SI_Fig3_systole_rr.pdf');
    out_png = fullfile(paths.figures, 'SI_Fig3_systole_rr.png');
    out_fig = fullfile(paths.figures, 'SI_Fig3_systole_rr.fig');
