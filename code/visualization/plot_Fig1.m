...
% Tom Froese, OIST Embodied Cognitive Science Unit
    ...
    group_names = {'Healthy Control', 'Patients (non-pathological ECG)', 'Patients (pathological ECG)'};
    labels_a = cell(3, 1);
    for g = 1:3
        m  = group_modes(g);
        ...
        % Two-line format keeps the legend within panel width given the
        % long group labels (group name + n on line 1; mode + CI on line 2).
